          ...
          <div className="container flex flex-col items-center gap-8">
            <div className="flex flex-col items-center gap-6">
              ...
              <p>
                ...
                veulent faire exploser le laboratoire pour répandre
                définitivement la contagion.
              </p>
              <p>
                ...
                <span className="text-amber-600">Explosion</span> est révélée,
                ou si aucun Remède n&apos;est trouvé au bout des 4 manches.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="flex flex-col items-center gap-2 rounded-md border-1 border-neutral-700 p-4 md:flex-row">
                ...
                <p className="md:w-xl">
                  ...
                  représentés par les cartes Rôle avec un fond vert. L’objectif
                  de ces membres est de trouver les différents remèdes avant que
                  les Infectés fassent exploser le laboratoire.
                </p>
              </div>
              <div className="flex flex-col items-center gap-2 rounded-md border-1 border-neutral-700 p-4 md:flex-row">
                ...
                <p className="md:w-xl">
                  Les membres de l’équipe{' '}
                  <span className="text-red-400">Infectés</span> sont
                  représentés par les cartes Rôle avec un fond rouge. L’objectif
                  de ces membres est de faire exploser la{' '}
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <p>
                ...
                déclencher l’explosion du laboratoire. Elles se divisent en
              ...
              <div className="flex flex-col items-center gap-2 rounded-md border-1 border-neutral-700 p-4 md:flex-row">
                ...
                <p className="md:w-xl">
                  ...
                  <span className="text-emerald-400">Docteurs</span>. Si tous
                  les Remèdes en jeu sont découverts, l’humanité est sauvée.
                </p>
              </div>
              <div className="flex flex-col items-center gap-2 rounded-md border-1 border-neutral-700 p-4 md:flex-row">
                ...
                <p className="md:w-xl">
                  Déclencher la carte{' '}
                  <span className="text-amber-600">Explosion</span> provoquera
                  la destruction du laboratoire et offre la victoire à l’équipe
                  des
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <p className="italic">
                *Remarque : Dans les parties à 4 et 7 joueurs, une des cartes
                Rôle ne sera pas distribuée. Elle sera mise de côté après la
                ...
                <span className="text-emerald-400">Docteurs</span> dans la
                partie en cours.
              </p>
              <br />
              <p>
                Chaque joueur reçoit également un ensemble de cartes contenant
                un mélange de : <span className="text-blue-400">Remèdes</span>,{' '}
                <span className="text-neutral-400">Substances Neutres</span> et{' '}
                <span className="text-amber-600">Explosion</span>.
              </p>
              <p>
                La répartition des cartes en fonction du nombre de joueurs est
                la suivante :
              </p>
              <table>
                <tbody>
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <ul className="flex max-w-3xl list-decimal flex-col gap-3 px-8 text-left">
                <li>
                  Les joueurs consultent leur main et indiquent si ils sont
                  prêts à jouer la manche.
                </li>
                <li>
                  Les joueurs discutent librement entre eux pour tenter
                  d’orienter les choix d’analyse.
                </li>
                <li>
                  <p>
                    À tour de rôle, chaque joueur choisit une Carte chez un
                    autre joueur à analyser.
                  </p>
                  <ul className="mt-2 ml-8 list-disc">
                    <li>Il est interdit d’analyser ses propres cartes.</li>
                    <li>
                      L’analyse révèle immédiatement le contenu de la carte à
                      tous les joueurs.
                    </li>
                  </ul>
                </li>
                ...
                <li>
                  ...
                  <br />
                  Une nouvelle manche démarre avec une carte de moins pour
                  chaque joueur comparée à la manche précédente.
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <ul className="flex list-decimal flex-col gap-3 px-8 text-left">
                <li>
                  Tous les <span className="text-blue-400">Remèdes</span> ont
                  été découverts.
                  <br />
                ...
                <li>
                  La carte <span className="text-amber-600">Explosion</span> a
                  été révélée.
                  <br />
                  Les membres de l&apos;équipe des{' '}
                  <span className="text-red-400">Infectés</span> gagne
